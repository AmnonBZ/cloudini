...
# import sys
#
# def ShowAllBuckets(activatedPolicy):
...
#                 try:
#                     try:
#                         validator = Violation.objects.get(connectedPolicy=activatedPolicy, resourceName=instance["Name"])
#                         if validator:
#                             validator.isChecked = True
#                             validator.isFixed = False
#                             validator.save()
#                         else:
#                             Violation.objects.create(connectedPolicy=activatedPolicy,resourceName=instance["Name"],date=datetime.now().strftime("%F %H:%M:%S"),isChecked=True,isFixed=False)
#
